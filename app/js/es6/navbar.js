  ...
  var navbar = {
    ...
    bindEvents: function bindEvents() {
      ...
      this.window.on('scroll', function () {
        ...
        _this.backgroundImageScroll();
        _this.appendLogoHeader();
      });
